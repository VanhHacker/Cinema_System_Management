...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="m-0 text-dark">
            ...
            Chi tiết doanh thu <span class="text-success fw-bold">Tháng {{ $month }}/{{ $year }}</span>
        </h4>
    ...
    <div class="card border-0 shadow-sm">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-5 text-muted">
                                ...
                                Không có giao dịch nào được thực hiện trong tháng này!
                            </td>
                        </tr>
                    @endforelse
                    </tbody>
        ...
        <div class="card-footer bg-white text-end py-3">
            <h5 class="m-0">Tổng doanh thu Tháng {{ $month }}: <span class="text-success fw-bold">{{ number_format($bills->sum('total'), 0, ',', '.') }} ₫</span></h5>
        </div>
    </div>
